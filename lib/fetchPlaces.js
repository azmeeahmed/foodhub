 ...
 *
 * Instagram column:
 *   Paste a single Instagram POST URL in the `instagram_url` column.
 *   Example value in the cell:
 *     https://www.instagram.com/p/DUTp1j5kr0r/
 *   Only post URLs (/p/...) and reel URLs (/reel/...) work as embeds.
 *   Profile URLs (instagram.com/username) cannot be embedded.
 */
      ...
      complete: (results) => {
        const places = results.data
          .map((row, index) => ({
            ...
            // Paste a post URL e.g. https://www.instagram.com/p/ABC123/
